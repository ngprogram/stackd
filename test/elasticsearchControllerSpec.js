...
describe("Elasticsearch Spec", function() {
  ...
  it('should create a sentiment', function(done) {
    var sampleSentiment = { "rating" : -0.5274215517597863, "score" : 0, "commentId" : "9070882", "title" : "Ask HN: TrueCrypt audit status?", "time" : 1424293091, "source" : "Hacker News", "sentiment" : "lose", "comment" : "Pedantic, but hopefully in a fun way:<p>Authentication is the biggest problem with sector-level crypto, but the other technical problem with encrypting sectors is that you don&#x27;t get a place to store the metadata you&#x27;d need to randomize the encryption, and so you lose semantic security as well. If you squint at it the right way, XTS is the ECB mode of sector-level (wide-block) crypto schemes.", "__v" : 0 };
...
it('should return a result', function(done) {
  elasticsearchController.search('audit')
    .then(function(response) {
